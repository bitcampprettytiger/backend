...
//  authorizaRequests.requestMatchers("/api/**").hasAuthority("ROLE_BASIC");
    authorizaRequests.requestMatchers("/api/**","/member/**","/vendor/join","/API/validateByRegion","/vendor/info","/reviews/**","/logout","/test-api-local.com/api/swagger-ui/index.html").permitAll();
