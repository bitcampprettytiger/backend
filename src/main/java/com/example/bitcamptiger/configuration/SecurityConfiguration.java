...
//  authorizaRequests.requestMatchers("/api/**").hasAuthority("ROLE_BASIC");
    ...
    "/API/gyeonggi/GyeonggiData","/API/gangNam/GangNamData","/API/dobonggu/DobongguData","/API/dongJak/validateDongJak","/API/dobonggu/**","/API/gangNam/validateGangNam","/API/gyeonggi/validateGyeonggi","/API/dongdaemun/**","/API/gangseogu/validateGangseo","/API/dongJak/NoRyangJin","/app/users/auth2/google/login/callback","/api/callback").permitAll();
