...
//        String requestBody = objectMapper.writeValueAsString(jsonObject);
        ...
        ResponseEntity<ValidationResponseDto> response = restTemplate.exchange(url, HttpMethod.POST, entity, ValidationResponseDto.class);

        //API 응답으로 받은 ValidationResponseDto
